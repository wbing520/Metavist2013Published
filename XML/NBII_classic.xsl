...
-->
			...
			<dd>
				<dl>
									...
									<dd>
										<dl>
											...
											<xsl:for-each select="boundalt">
												<dt>
													<i>Bounding_Altitudes:</i>
												</dt>
												<dl>
													<dt>
														<i>Altitude_Minimum: </i>
														<xsl:value-of select="altmin" />
													</dt>
													<dt>
														<i>Altitude_Maximum: </i>
					...
					<xsl:for-each select="taxonomy">
						...
						<dl>
							<xsl:for-each select="keywtax">
								...
								<dl>
									<dt>
										<i>Taxonomic_Keyword_Thesaurus:</i>
									</dt>
									<dd>
							...
							<xsl:for-each select="taxonsys">
								<dt>
									<i>Taxonomic_System:</i>
								</dt>
								<dl>
									<xsl:for-each select="classsys">
										<dt>
											<i>Classification_System/Authority:</i>
										</dt>
										<dl>
											<xsl:for-each select="classcit">
												<dt>
													<i>Classification_System_Citation:</i>
												</dt>
												<dl>
													<xsl:apply-templates select="citeinfo" />
												</dl>
											...
											<xsl:for-each select="classmod">
												<dt>
													<i>Classification_System_Modifications:</i>
												</dt>
												<dd>
													<xsl:value-of select="." />
												</dd>
							...
							<xsl:for-each select="taxongen">
								<dt>
									<i>General_Taxonomic_Coverage:</i>
								</dt>
								<dd>
									<xsl:value-of select="." />
								</dd>
					...
					<xsl:for-each select="tool">
						...
						<dl>
							<dt>
								<i>Analytical_Tool_Description:</i>
							</dt>
							<dd>
							...
							<xsl:for-each select="toolacc">
								...
								<dl>
									...
									<xsl:for-each select="toolcomp">
										<dt>
											<i>Tool_Computer_and_Operating_System:</i>
										</dt>
										<dd>
											<xsl:value-of select="." />
										</dd>
					...
					<xsl:for-each select="lineage">
						...
						<dl>
							<xsl:for-each select="method">
								...
								<dl>
									<dt>
										<i>Methodology_Type: </i>
										<xsl:value-of select="methtype" />
									</dt>
									<xsl:for-each select="methodid">
										<dt>
											<i>Methodolgy_Identifier:</i>
										</dt>
										<dl>
											<dt>
												<i>Methodolgy_Keyword_Thesaurus:</i>
											</dt>
											<dd>
									...
									<dd>
										<xsl:value-of select="methdesc" />
									</dd>
									<xsl:for-each select="methcite">
										<dt>
											<i>Methodology_Citation:</i>
										</dt>
										<dl>
											<xsl:apply-templates select="citeinfo" />
										</dl>
												...
												<dd>
													<dl>
														...
														<xsl:for-each select="asciistr">
															<dt>
																<i>ASCII_File_Structure:</i>
															</dt>
															<dl>
																<xsl:for-each select="recdel">
																	<dt>
																		<i>Record_Delimiter: </i>
																		<xsl:value-of select="." />
																	</dt>
																</xsl:for-each>
																<xsl:for-each select="numheadl">
																	<dt>
																		<i>Number_Header_Lines: </i>
																		<xsl:value-of select="." />
																	</dt>
																</xsl:for-each>
																<xsl:for-each select="deschead">
																	<dt>
																		<i>Description_of_Header_Content:</i>
																	</dt>
																	<dd>
																		<xsl:value-of select="." />
																	</dd>
																...
																<xsl:for-each select="datafiel">
																	...
																	<dl>
																		...
																		<xsl:for-each select="missingv">
																			<dt>
																				<i>Missing_Value_Code: </i>
																				<xsl:value-of select="." />
																			</dt>
																		</xsl:for-each>
																		<xsl:for-each select="dfwidthd">
																			<dt>
																				<i>Data_Field_Width_Delimiter: </i>
																				<xsl:value-of select="." />
																			</dt>
																		</xsl:for-each>
																		<xsl:for-each select="dfwidth">
																			<dt>
																				<i>Data_Field_Width: </i>
																				<xsl:value-of select="." />
																			</dt>
																		</xsl:for-each>
																	</dl>
	...
	<xsl:template match="geolage">
		...
		<xsl:for-each select="geolscal">
			<dt>
				<i>Geologic_Time_Scale: </i>
				<xsl:value-of select="." />
			</dt>
		</xsl:for-each>
		<xsl:for-each select="geolest">
			<dt>
				<i>Geologic_Age_Estimate: </i>
				<xsl:value-of select="." />
			</dt>
		</xsl:for-each>
		<xsl:for-each select="geolun">
			<dt>
				<i>Geologic_Age_Uncertainty: </i>
				<dd>
					<xsl:value-of select="." />
				</dd>
			</dt>
