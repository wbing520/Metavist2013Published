...
function getcomputeddisplay(elem) {
	...
	<xsl:template name="footer">
		<div class="md-footer">
			<a target="viewer">
				<xsl:attribute name="href">http://www.fgdc.gov/</xsl:attribute>Federal Geographic Data Committee
			</a>
		</div>
	</xsl:template>
			...
			<xsl:for-each select="/metadata/idinfo[normalize-space(.) != '']">
				...
				<div class="md-detailhide">
					...
					<xsl:for-each select="native[normalize-space(.) != '']">
						<div class="md">
							<b>Native dataset environment: </b>
							<xsl:value-of select="." />
						</div>
					</xsl:for-each>
				</div>
					...
					<div class="md-itemhide">
						<xsl:for-each select="dsgpoly[dsgpolyo[normalize-space(.) != ''] or dsgpolyx[normalize-space(.) != '']]">
							<div class="md-itemlist">
								Data set G-Polygon <xsl:value-of select="position()" />:
							</div>
							<div class="md-itemshow">
				...
				<xsl:if test="minalti[normalize-space(.) != ''] or maxalti[normalize-space(.) != ''] or altunits[normalize-space(.) != '']">
					...
					<div class="md-itemhide">
						...
						<xsl:for-each select="altunits[normalize-space(.) != '']">
							<div class="md">
								<b>Altitude units: </b>><xsl:value-of select="." />
							</div>
						</xsl:for-each>
					</div>
				</xsl:if>
		...
		<xsl:for-each select="/metadata/idinfo/secinfo[secsys[normalize-space(.) != ''] or secclass[normalize-space(.) != ''] or sechandl[normalize-space(.) != '']]">
			...
			<div class="md-detailhide">
				...
				<xsl:for-each select="secsys[normalize-space(.) != '']">
					<div class="md">
						<b>Security classifiction system: </b>
						<xsl:value-of select="." />
					</div>
				</xsl:for-each>
	...
	<xsl:template name="browse_graphic">
		...
		<div class="md-detailhide">
			...
			<xsl:for-each select="/metadata/idinfo/browse[browsen[normalize-space(.) != ''] or browsed[normalize-space(.) != ''] or browset[normalize-space(.) != '']]">
				...
				<div class="md">
					<b>
						Browse graphic <xsl:number value="position()" format="1" />
					</b>
				</div>
				<div class="md-indent">
					<xsl:choose>
						<xsl:when test="$typeBG = 'JPG' or $typeBG = 'JPEG' or $typeBG = 'GIF' or $typeBG = 'PNG' or $typeBG = 'BMP'">
							<div class="md">
								<xsl:for-each select="browsen[normalize-space(.) != '']">
									<span class="md-bgraphic">
										<xsl:attribute name="browsen">
											<xsl:value-of select="." />
										</xsl:attribute>Open
									</span>
								</xsl:for-each>
							...
							<div class="md-detailhide">
								<img class="md-bgraphicimg">
									<xsl:attribute name="src">
										<xsl:text>nothing</xsl:text>
									</xsl:attribute>
									<xsl:attribute name="alt">
										<xsl:text>Graphic Image</xsl:text>
									</xsl:attribute>
								</img>
							</div>
						</xsl:when>
		...
		<xsl:for-each select="/metadata/dataqual[logic[normalize-space(.) != ''] or complete[normalize-space(.) != ''] or cloud[normalize-space(.) != '']]">
			...
			<div class="md-detailhide">
				...
				<xsl:for-each select="logic[normalize-space(.) != '']">
					<div class="md">
						<b>Logical consistency report: </b>
						<pre id="fixvalue">
							<xsl:value-of select="." />
						</pre>
					</div>
		...
		<xsl:for-each select="/metadata/dataqual/attracc[attraccr[normalize-space(.) != ''] or qattracc/attraccv[normalize-space(.) != ''] or qattracc/attracce[normalize-space(.) != '']]">
			...
			<div class="md-detailhide">
				...
				<xsl:if test="qattracc[normalize-space(.) != '']">
					<div class="md">
						<b>Attribute accuracy assessment:</b>
					</div>
			...
			<div class="md-detailhide">
				...
				<xsl:for-each select="horizpa[horizpar[normalize-space(.) != ''] or qhorizpa[horizpae[normalize-space(.) != '']]]">
					<xsl:for-each select="horizpar[normalize-space(.) != '']">
						<div class="md">
							<b>Horizontal accuracy report: </b>
							<pre id="fixvalue">
								<xsl:value-of select="." />
							</pre>
						</div>
					...
					<xsl:if test="qhorizpa[horizpae[normalize-space(.) != '']]">
						<div class="md">
							<b>Horizontal positional accuracy assessment:</b>
						</div>
						<div class="md-itemlist">Accuracy values</div>
						<div class="md-itemshow">
				...
				<xsl:for-each select="vertacc[vertaccr[normalize-space(.) != ''] or qvertpa[vertacce[normalize-space(.) != '']]]">
					...
					<xsl:if test="qvertpa[vertacce[normalize-space(.) != '']]">
						<div class="md">
							<b>Vertical positional accuracy assessment:</b>
						</div>
						<div class="md-itemlist">Accuracy values</div>
						<div class="md-itemshow">
			...
			<div class="md-detailhide">
				...
				<div class="md-itemshow">
					<xsl:for-each select="/metadata/dataqual/lineage/procstep[normalize-space(.) != '']">
						<div class="md-itemlist">
							Process Step <xsl:number value="position()" format="1" />
						</div>
						<div class="md-itemhide">
							<!-- Start Shoreline Data Profile element -->
							...
							<xsl:if test="procdate[normalize-space(.) != '']">
								<div class="md">
									...
									<xsl:if test="proctime[normalize-space(.) != '']">
										<b> Process time: </b>
						...
						<xsl:for-each select="proctime[normalize-space(.) != '']">
							...
							<xsl:for-each select="procsv[normalize-space(.) != '']">
								<div class="md">
									<b>Process software and version: </b>
									<xsl:value-of select="." />
								</div>
							</xsl:for-each>
									...
									<xsl:for-each select="srcused[normalize-space(.) != '']">
										...
										<xsl:choose>
											...
											<xsl:otherwise>
												<div class="md-indent">
													<b>
														<xsl:value-of select="$SrcCiteaUsed" />
													</b>
												</div>
											</xsl:otherwise>
										</xsl:choose>
									...
									<xsl:for-each select="srcprod[normalize-space(.) != '']">
										...
										<xsl:choose>
											...
											<xsl:otherwise>
												<div class="md-indent">
													<b>
														<xsl:value-of select="$SrcCiteaProd" />
													</b>
												</div>
											</xsl:otherwise>
										</xsl:choose>
						...
						<div class="md-itemhide">
							<xsl:if test="@Date[normalize-space(.) != '']">
								<div class="md">
									...
									<xsl:if test="@Time[normalize-space(.) != '']">
										<b> Time: </b>
							...
							<xsl:if test="@ToolSource">
								<div class="md">
									<b>Tool location: </b>
									<xsl:value-of select="@ToolSource" />
								</div>
							</xsl:if>
							<div class="md">
								<b>Command issued: </b>
						...
						<div class="md-itemhide">
							...
							<xsl:if test="partTopoRules">
								<xsl:choose>
									...
									<xsl:otherwise>
										<div class="md">
											<b>Participates in topology rules:</b>
										</div>
										<div class="md-indent">
											<xsl:for-each select="partTopoRules[normalize-space(.) != '']">
	...
	<xsl:template name="data_organization_esri_geometric_network">
		...
		<xsl:for-each select="/metadata/spdoinfo/netinfo[normalize-space(.) != '']">
			...
			<div class="md-detailhide">
				<div id="md-def" name="md-def" class="md-def">
					Description of ESRI geometric network, which maintains topological relationships between the
					features in many feature classes in a geodatabase.
				</div>
				...
				<xsl:if test="elemcls[normalize-space(.) != '']">
					...
					<div class="md-itemshow">
						<xsl:for-each select="elemcls[normalize-space(.) != '']">
							<div class="md-item">
								<xsl:value-of select="position()" /><xsl:text>. </xsl:text>Network element
							</div>
							<div class="md-itemhide">
								...
								<xsl:for-each select="rolefld[normalize-space(.) != '']">
									<div class="md">
										<b>Ancillary role attribute: </b>
										<xsl:value-of select="." />
									</div>
								</xsl:for-each>
								<xsl:for-each select="enabfld[normalize-space(.) != '']">
									<div class="md">
										<b>Enabled attribute: </b>
										<xsl:value-of select="." />
									</div>
								</xsl:for-each>
							</div>
					...
					<xsl:if test="Properties/FileMAT[normalize-space(.) != ''] or Properties/FileSTN[normalize-space(.) != ''] or Properties/IntFileMAT[normalize-space(.) != ''] or Properties/IntFileSTN[normalize-space(.) != '']">
						...
						<div class="md-indent">
							...
							<xsl:for-each select="Properties/IntFileSTN[normalize-space(.) != '']">
								<div class="md">
									<b>Intersection standardization rules: </b>
									<xsl:value-of select="." />
								</div>
							</xsl:for-each>
						</div>
			...
			<div class="md-detailhide">
				...
				<xsl:for-each select="/metadata/eainfo/overview[dsoverv[normalize-space(.) != ''] or eaover[normalize-space(.) != ''] or eadetcit[normalize-space(.) != '']]">
					...
					<xsl:for-each select="eaover[normalize-space(.) != '']">
						<div class="md">
							<b>Entity and attribute overview: </b>
							<pre id="fixvalue">
								<xsl:value-of select="." />
							</pre>
						</div>
					...
					<xsl:for-each select="eadetcit[normalize-space(.) != '']">
						<div class="md-indent">
							<div class="md">
								<b>Entity and attribute detailed citation: </b>
								<pre id="fixvalue">
									<xsl:value-of select="." />
								</pre>
							</div>
				...
				<xsl:for-each select="/metadata/spdoinfo[direct[normalize-space(.) != ''] or indspref[normalize-space(.) != '']]">
					<xsl:for-each select="direct[normalize-space(.) != '']">
						<div class="md">
							<b>Direct spatial reference method: </b>
							<xsl:value-of select="." />
						</div>
					</xsl:for-each>
					<xsl:for-each select="indspref[normalize-space(.) != '']">
						<div class="md">
							<b>Indirect spatial reference method: </b>
							<xsl:value-of select="." />
						</div>
					</xsl:for-each>
				</xsl:for-each>
									...
									<div class="md-itemshow">
										<table class="md-grid">
											...
											<xsl:for-each select="attrunit[normalize-space(.) != '']">
												<tr>
													<td>Attribute units of measurement</td>
													<td>
														<xsl:value-of select="." />
													</td>
												</tr>
											...
											<xsl:for-each select="attrmres[normalize-space(.) != '']">
												<tr>
													<td>Attribute measurement resolution</td>
													<td>
														<xsl:value-of select="." />
													</td>
												</tr>
	...
	<xsl:template name="attributes_esri_relationship_definition">
		...
		<div class="md-indent">
			...
			<xsl:for-each select="relcomp[normalize-space(.) != '']">
				<xsl:choose>
					<xsl:when test=". = 'TRUE'">
						<div class="md">
							<b>Type of relationship: </b>Composite
						</div>
					</xsl:when>
					<xsl:otherwise>
						<div class="md">
							<b>Type of relationship: </b>Simple
						</div>
					</xsl:otherwise>
				</xsl:choose>
			</xsl:for-each>
		...
		<div class="md">
			<b>Destination table information:</b>
		</div>
		<div class="md-indent">
								...
								<xsl:for-each select="onlinopt[normalize-space(.) != '']">
									...
									<div class="md-indent">
										<xsl:for-each select="computer[normalize-space(.) != '']">
											...
											<div class="md-indent">
												...
												<xsl:for-each select="sdeconn[//*[normalize-space(.) != '']]">
													<div class="md">
														<b>Spatial Database connection:</b>
													</div>
													<div class="md-indent">
										...
										<xsl:for-each select="oncomp[normalize-space(.) != '']">
											<div class="md">
												<b>Online computer and operating system: </b>
												<xsl:value-of select="." />
											</div>
										</xsl:for-each>
									</div>
		...
		<xsl:for-each select="/metadata/metainfo[metd[normalize-space(.) != ''] or metrd[normalize-space(.) != ''] or metfrd[normalize-space(.) != ''] or langmeta[normalize-space(.) != '']]">
			...
			<div class="md-detailhide">
				...
				<xsl:for-each select="metrd[normalize-space(.) != '']">
					<div class="md">
						<b>Last metadata review date: </b>
						<xsl:value-of select="." />
					</div>
				</xsl:for-each>
				<xsl:for-each select="metfrd[normalize-space(.) != '']">
					<div class="md">
						<b>Future metadata review date: </b>
						<xsl:value-of select="." />
					</div>
				</xsl:for-each>
				<!-- ESRI Profile element -->
		...
		<xsl:for-each select="/metadata/metainfo[metstdn[normalize-space(.) != ''] or metstdv[normalize-space(.) != ''] or mettc[normalize-space(.) != ''] or metextns[*[normalize-space(.) != '']]]">
			...
			<div class="md-detailhide">
				...
				<xsl:if test="metextns[normalize-space(.) != '']">
					<div class="md">
						<b>Metadata profiles defining additonal information:</b>
					</div>
	...
	<xsl:template name="metadata_fgdc_plus_stylesheet">
		...
		<div class="md-detailhelp">
			<div class="md">
				<b>Stylesheet: </b>FGDC Plus Stylesheet
			</div>
			<div class="md">
				<b>File name: </b>FGDC Plus.xsl
			</div>
			<div class="md">
				<b>Version: </b>2.0
			</div>
			...
			<div class="md">
				<b>Instructions: </b>On the top of the page, click on the title of the dataset to toggle opening and closing of all metadata content sections or click section links listed horizontally below the title to open individual sections. Click on a section name (e.g. Description) to open and close section content. Within a section, click on a item name (Status, Key Words, etc.) to open and close individual content items. By default, the Citation information within the Description section is always open for display.
			</div>
			<div class="md">
				<b>Download: </b>FGDC Plus Stylesheet is available from the ArcScripts downloads at <a target="viewer" href="http://www.esri.com">www.esri.com</a>.
			</div>
		</div>
	</xsl:template>
			...
			<xsl:for-each select="/metadata/spref/horizsys[normalize-space(.) != '']">
				...
				<div class="md-detailhide">
					...
					<xsl:if test="cordsysn/projcsn[normalize-space(.) != '']">
						<div class="md">
							<b>Projected coordinate system:</b>
						</div>
						<div class="md-indent">
							<!-- ESRI Profile element -->
					...
					<xsl:if test="cordsysn/geogcsn[normalize-space(.) != '']">
						<div class="md">
							<b>Geographic coordinate system:</b>
						</div>
						<div class="md-indent">
							<!-- ESRI Profile element -->
		...
		<xsl:for-each select="/metadata/spref/vertdef[normalize-space(.) != '']">
			...
			<div class="md-detailhide">
				...
				<xsl:for-each select="altsys[normalize-space(.) != '']">
					<div class="md">
						<b>Altitude system definition:</b>
					</div>
					<div class="md-indent">
			...
			<xsl:for-each select="rngdates[normalize-space(.) != '']">
				<xsl:if test="begdate[normalize-space(.) != '']">
					<div class="md">
						...
						<xsl:if test="begtime[normalize-space(.) != '']">
							<b> Beginning time: </b>
				...
				<xsl:if test="enddate[normalize-space(.) != '']">
					<div class="md">
						...
						<xsl:if test="endtime[normalize-space(.) != '']">
							<b> Ending time: </b>
	...
	<xsl:template name="citation_info">
		...
		<xsl:if test="pubdate[normalize-space(.) != '']">
			<div class="md">
				...
				<xsl:if test="pubtime[normalize-space(.) != '']">
	...
	<xsl:template name="contact_info">
		...
		<xsl:for-each select="cnttdd[normalize-space(.) != '']">
			<div class="md">
				<b>Telecommunications Device or Teletypewriter (TDD/TTY) phone: </b>
				<xsl:value-of select="." />
			</div>
		</xsl:for-each>
...
>
	...
	<xsl:template name="data_source_info">
		<xsl:choose>
			...
			<xsl:otherwise>
				<div class="md-item">
					Data Source <xsl:number value="position()" format="1" />
				</div>
			</xsl:otherwise>
		</xsl:choose>
		<div class="md-itemhide">
				...
				<div class="md-indent">
					...
					<xsl:choose>
						<xsl:when test="(allOriginSubtypes = 'FALSE') and ((stname !='') or (stcode != ''))">
							<div class="md">
								<b>Subtype code and name: </b>
								<xsl:value-of select="stcode" />
								<xsl:if test="stname != '' and stcode != ''"> - </xsl:if>
						...
						<xsl:otherwise>
							<xsl:for-each select="allOriginSubtypes[normalize-space(.) != '']">
								<div class="md">
									<b>Applies to all origin subtypes: </b>
									<xsl:value-of select="." />
								</div>
							</xsl:for-each>
						</xsl:otherwise>
					...
					<xsl:choose>
						...
						<xsl:otherwise>
							<xsl:for-each select="allDestSubtypes[normalize-space(.) != '']">
								<div class="md">
									<b>Applies to all destination subtypes: </b>
									<xsl:value-of select="." />
								</div>
							</xsl:for-each>
						</xsl:otherwise>
	...
	<xsl:template name="descgeog">
		<xsl:for-each select="descgeog[normalize-space(.) != '']">
			<div class="md">
				<b>Description of geographic extent: </b>
				<pre id="fixvalue">
					<xsl:value-of select="." />
				</pre>
			</div>
		...
		<xsl:for-each select="/metadata/idinfo/taxonomy[taxongen[normalize-space(.) != ''] or keywtax[normalize-space(.) != ''] or taxonsys[normalize-space(.) != ''] or taxoncl[normalize-space(.) != '']]">
			...
			<div class="md-detailhide">
							...
							<xsl:for-each select="classsys[normalize-space(.) != '']">
								...
								<div class="md-indent">
									...
									<xsl:for-each select="classmod[normalize-space(.) != '']">
										<div class="md">
											<b>Classification system modification: </b>
											<xsl:value-of select="." />
										</div>
									</xsl:for-each>
								</div>
				...
				<xsl:for-each select="taxongen[normalize-space(.) != '']">
					<div class="md">
						<b>General taxonomic coverage: </b>
						<xsl:value-of select="." />
					</div>
				</xsl:for-each>
	...
	<xsl:template name="biological_method_info">
		<div class="md-item">
			Method <xsl:number value="position()" format="1" />
		</div>
		<div class="md-itemhide">
				...
				<xsl:for-each select="tidinfo[normalize-space(.) != '']">
					...
					<div class="md-indent">
						...
						<xsl:for-each select="tidref[normalize-space(.) != '']">
							<div class="md">
								<b>Tide table reference: </b>
								<xsl:value-of select="." />
							</div>
						</xsl:for-each>
						<xsl:for-each select="tidsup[normalize-space(.) != '']">
							<div class="md">
								<b>Supplemental tidal information: </b>
								<pre id="fixvalue">
									<xsl:value-of select="." />
								</pre>
							</div>
